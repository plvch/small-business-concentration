...
COVER = '''<section class="cover col">
  ...
  <p class="standfirst">Germany barely taxes its small businesses, so it mostly leaves them to the
  notary and the forms. By the numbers, that's rational. What could change it is the part I haven't
  worked out.</p>
  <div class="byline">
