...
/* magazine line-breaking: hyphenate + justify body so rows divide cleanly */
.prose p, .methods p{text-align:justify;-webkit-hyphens:auto;hyphens:auto;hyphenate-limit-chars:7 4 3}
figcaption{-webkit-hyphens:auto;hyphens:auto}
...
COVER = '''<section class="cover col">
  ...
  <h1>It's a (sadly) rational policy to ignore small business</h1>
  <div class="byline">
...
def rule(n, t): return f'<div class="section-rule"><div class="n">§ {n}</div><div class="t">{t}</div></div>'

INTRO = f'''<section class="essay"><div class="col"><div class="prose">
...
SEC1 = f'''<section class="essay">
  <div class="col">
    {rule("01","The concentration")}
    <h2 class="section-title">Where the turnover actually sits.</h2>
    <div class="prose">{p("Micro firms aren't rare. Germany has around 7&nbsp;million VAT-registered businesses, and about 5&nbsp;million of them turn over less than €100k a year. Those 5&nbsp;million together make 1.2% of all turnover. The top 1% of firms make roughly 80%. Just 3,190 companies, 0.04% of the total, book more than half. Tax and social revenue track the same curve, by proxy.")}</div>
  </div>
  ...
  <div class="col"><div class="prose">{p("Nothing on the personal side comes close. The corporate turnover Gini sits near 0.96; personal income is around 0.5. That's less a verdict on big firms than a map of where the money sits.")}</div></div>
</section>'''

SEC2 = f'''<section class="essay">
  <div class="col">
    {rule("02","Germany vs Europe")}
    <h2 class="section-title">Concentrated even by European standards.</h2>
  </div>
  <figure class="fig col-wide">
  ...
  <div class="col"><div class="prose">{p("And Germany isn't middling here. On both common measures of corporate concentration it sits at or near the top, above France, Italy and Spain. So the neglect makes sense. If the small end is a rounding error in the base, leaving founders to the notary and the forms is the rational call. The concentration is hard, and it's set at the level of the whole economy.")}</div></div>
</section>'''

SEC3 = f'''<section class="essay"><div class="col">
  {rule("03","What would change it")}
  <h2 class="section-title">Tax revenue won't supply the reason.</h2>
  <div class="prose">
...
METHODS = '''<section class="essay"><div class="col">
  <div class="methods">
    <h4>Method &amp; sources</h4>
    <p>Everything here is computed from primary public statistics — no commercial databases. Business-turnover concentration: Destatis Umsatzsteuerstatistik (Veranlagungen), table 73321-0004, reporting year 2021 — 7.2&nbsp;million VAT-registered businesses and €8.1tn of taxable turnover. Personal income: Lohn- u. Einkommensteuerstatistik (73111-0005), 2022. Cross-country comparison: Eurostat Structural Business Statistics and the IWH/CompNet firm-concentration study.</p>
    <ul>
      <li>The corporate turnover Gini (~0.96) is a grouped estimate from turnover size-class bands; the true value is higher. The cross-country Gini uses five employment-size bands, so it is a lower bound — read the ranking, not the level.</li>
      <li>HHI and the turnover Gini measure different things. Germany is #1 on the turnover Gini but 6th on HHI: its turnover sits in large, low-markup firms, not monopolised markets.</li>
      <li>Personal income here is Gesamtbetrag der Einkünfte — pre-tax taxpayer income, Gini ~0.49. The household disposable-income Gini usually quoted for Germany is about 0.28 (Eurostat SILC), a different concept.</li>
      <li>Turnover is a proxy for the tax and social-contribution base, not tax actually paid; the statistic also largely excludes the smallest Kleinunternehmer (under €22k).</li>
    </ul>
    <p>Sources: Destatis GENESIS <span class="mono">73321-0004</span> (Umsatzsteuer), <span class="mono">73111-0005</span> (Lohn-/Einkommensteuer); Eurostat <span class="mono">sbs_sc_ovw</span> (SBS, 2023) and <span class="mono">ilc_di12</span> (SILC disposable-income Gini); Bighelli, Di&nbsp;Mauro, Melitz &amp; Mertens, &ldquo;European Firm Concentration and Aggregate Productivity,&rdquo; IWH-CompNet Discussion Papers 3/2021.</p>

    <h4 style="margin-top:28px">Disclaimer</h4>
    <p>This is independent research commentary, written for general information. It is not investment, legal, tax or policy advice. All figures are the author's calculations from public statistics, may contain errors, and describe a moment in time. Statistical-office, agency and dataset names are used for identification only and imply no affiliation or endorsement. If you find an error, the underlying tables are public and I'd rather hear about it than not.</p>
  </div>
</div></section>'''
...
ENDMATTER = '''<aside class="end-matter col-wide" aria-label="About and contact">
  <div>
    ...
    <p>Just a blog note. More on <a href="https://plvch.com">plvch.com</a>.</p>
  </div>
  <div>
    <h4>Contact</h4>
    <p>m(at)plvch.com</p>
...
<title>It's a (sadly) rational policy to ignore small business — plvch</title>
<meta name="description" content="72% of German firms make 1.2% of the turnover. By the numbers, ignoring small business is rational — the question is what could ever change it."/>
<meta property="og:type" content="article"/>
<meta property="og:title" content="It's a (sadly) rational policy to ignore small business"/>
<meta property="og:description" content="72% of German firms make 1.2% of the turnover; the top 1% make ~80%. By the numbers, ignoring small business is rational."/>
<meta property="og:url" content="https://plvch.github.io/small-business-concentration/"/>
